...
#define SLIPPAGE_FACTOR_U 0.87f	// Correction constant for slippage u direction
#define SLIPPAGE_FACTOR_V 0.91f  // Correction constant for slippage v direction
