...
class Trajectory1D {
   public:
     ...
     */
    void addTrajectory(const std::vector<rtt::BBTrajectoryPart> &newParts, double addFromTime);
    ...
    std::vector<rtt::BBTrajectoryPart> parts; /**< Vector containing all parts of the trajectory */
