#include "../top_board/Path_tracking/Trajectory1D.h"


namespace rtt {

void Trajectory1D::addTrajectory(const std::vector<rtt::BBTrajectoryPart>& newParts, double addFromTime) {
    ...
    for (rtt::BBTrajectoryPart newPart : newParts) {
...
double Trajectory1D::getAcceleration(double t) const {
    ...
    rtt::BBTrajectoryPart piece = parts[0];
