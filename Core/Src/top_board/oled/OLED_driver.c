...
static char *robotNames[] = {"404", "WALL-E", "Bob", "Pumba", "Ted", "Eve", "Susie", "James", "Lizzy", "McQueen", "Kevin", "Blueberry", "Van Robogh", "Wout", "Jenny", "Hermann"};
...
void OLED_Update(button_id_t button, bool test_mode)
{
    ...
    {
        if (!flag_error_too_many_children_page_init)
