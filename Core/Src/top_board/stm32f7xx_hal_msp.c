...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PC3     ------> ADC1_IN13
    */
    GPIO_InitStruct.Pin = RF_Current_Pin|RB_Current_Pin|LF_Current_Pin|LB_Current_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PC3     ------> ADC1_IN13
    */
    HAL_GPIO_DeInit(GPIOC, RF_Current_Pin|RB_Current_Pin|LF_Current_Pin|LB_Current_Pin);
